      ...
      <main className="flex-1">
        ...
        <section className="relative py-16 lg:py-20 bg-gradient-to-b from-slate-50 via-white to-slate-50/60 dark:from-slate-900 dark:via-slate-950 dark:to-slate-950 border-b border-slate-200/80 dark:border-slate-800/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
            ...
            <nav className="flex items-center justify-center space-x-2 text-xs font-semibold text-slate-500 dark:text-slate-400 mb-2">
              ...
              <span className="text-blue-600 dark:text-blue-400 font-bold">Pricing</span>
            </nav>
            ...
            <div className="pt-6 flex items-center justify-center">
              <div className="p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 inline-flex flex-wrap items-center justify-center gap-1 shadow-inner">
                <button
                  type="button"
              ...
              return (
                <div
                  ...
                  className={`relative flex flex-col justify-between rounded-3xl p-8 sm:p-9 transition-all duration-300 ${
                    pkg.isPopular
                      ? "bg-white dark:bg-slate-900 border-2 border-blue-600 dark:border-blue-500 shadow-2xl shadow-blue-500/10 lg:-translate-y-2"
                      : "bg-slate-50/80 dark:bg-slate-900/80 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-slate-300 dark:hover:border-slate-700"
                  }`}
                >
                  ...
                  <div>
                    ...
                    {/* Price Header */}
                    <div className="mb-5 pb-5 border-b border-slate-200/80 dark:border-slate-800">
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      {pkg.features.map((feat, idx) => (
                        <div key={idx} className="flex items-start gap-2.5 text-xs text-slate-700 dark:text-slate-300">
                          <div className="w-4 h-4 rounded-full bg-blue-50 dark:bg-blue-950/80 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0 mt-0.5">
        ...
        <section className="py-20 bg-slate-50 dark:bg-slate-900/60 border-t border-slate-200/80 dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 overflow-x-auto shadow-sm">
              <table className="w-full text-left border-collapse min-w-[700px]">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800 text-xs font-bold uppercase tracking-wider text-slate-400">
                    ...
                    <th className="py-4 px-3 text-center text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-950/40">
                      Corp Tax
                    </th>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 text-xs sm:text-sm">
                  {PRICING_COMPARISON_MATRIX.map((row, idx) => (
                    <tr key={idx} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-3.5 px-3 text-center bg-blue-50/30 dark:bg-blue-950/20">
                        {row.corpTax ? (
                          <Check className="w-4 h-4 text-blue-600 dark:text-blue-400 mx-auto font-bold" />
                        ) : (
                          <span className="text-slate-300 dark:text-slate-600">—</span>
                        )}
                      </td>
        ...
        <section className="py-12 bg-white dark:bg-slate-950 border-t border-slate-200/80 dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">AICPA Supervised</h4>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Audit Shield Guarantee</h4>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">SOC-2 Vault Security</h4>
              ...
              <div className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800">
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-900 dark:text-white">Guaranteed 3-Day Close</h4>
