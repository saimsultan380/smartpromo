          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredServices.map((service: ServiceItem) => {
              ...
              return (
                <div
                  key={service.id}
                  className="group relative flex flex-col justify-between rounded-3xl p-8 bg-slate-50/80 border border-slate-200/90 shadow-sm hover:shadow-2xl hover:border-blue-400/60 transition-all duration-300 hover:-translate-y-1"
                >
                  <div>
                    {/* Top Row: Icon + Metric Pill */}
                    <div className="flex items-center justify-between gap-4 mb-6">
                      <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-center justify-center text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
                    ...
                    {/* Feature bullet list */}
                    <div className="space-y-2 pt-4 border-t border-slate-200/70 mb-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-white border border-slate-200 text-slate-900 text-xs font-bold hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all flex items-center justify-between group/btn shadow-sm"
                  >
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-5 text-left font-bold text-sm sm:text-base text-slate-900 flex items-center justify-between gap-4 hover:bg-slate-50"
                  >
